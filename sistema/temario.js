  ...
  grid.innerHTML = `
    ...
    <div style="flex:1;display:flex;flex-direction:column;gap:0.4rem;font-family:'Roboto Condensed',sans-serif;justify-content:flex-start;padding-top:0;">
      ...
      <div style="font-size:0.93rem;color:var(--text);line-height:1.7;">
        ...
        <p>Como editor digital independiente, he trabajado en la elaboración y publicación de distintos materiales didácticos, entre ellos libros de texto, cuadernos de formulación y fichas de lectura orientadas a diferentes niveles educativos. Cada proyecto nace de un proceso de diseño y revisión minucioso, prestando especial atención tanto al contenido académico como a la estructura visual, la organización y la facilidad de uso.</p>
      </div>
